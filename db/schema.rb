...
ActiveRecord::Schema.define(version: 2019_12_18_111148) do
  ...
  create_table "transactions", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["sourceable_type", "sourceable_id"], name: "index_transactions_on_sourceable_type_and_sourceable_id"
    t.index ["targetable_type", "targetable_id"], name: "index_transactions_on_targetable_type_and_targetable_id"
  end
